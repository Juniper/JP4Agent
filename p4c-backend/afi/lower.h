...
#ifndef _BACKENDS_AFI_LOWER_H_
#define _BACKENDS_AFI_LOWER_H_
...
/**
  This pass rewrites expressions which are not supported natively.
*/
...
/**
We do not support complex expressions for a select
