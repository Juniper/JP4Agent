...
#ifndef _BACKENDS_AFI_ANALYZER_H_
#define _BACKENDS_AFI_ANALYZER_H_
...
// This CFG is only good for AFI, which only cares about some Nodes in the program
class CFG final : public IHasDbPrint {
 ...
 public:
    ...
    // Graphs that require cycles are not implementable on AFI.
...
#endif /* _BACKENDS_AFI_ANALYZER_H_ */
