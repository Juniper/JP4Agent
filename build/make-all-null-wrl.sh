...
#
# Usage:
#   make-all-null-wrl.sh clean
#   make-all-null-wrl.sh
#   make-all-null-wrl.sh install --destdir <destdir> --prefix <subdir> --confdir <subdir>
...
#     Example command:
#       make-all-null-wrl.sh install --destdir /opt --prefix /usr --confdir /etc
#
...
then
    ...
    do
        ...
        make -j1 -C ${component} DEBUG_BUILD=1 CODE_COVERAGE=1
        if [ $? -ne 0 ]
        then
          echo "$me: !!!!!!!!!!!ERROR!!!!!!!!!!" 
          echo "$me: !!!!!!!!!!!ERROR!!!!!!!!!!" 
